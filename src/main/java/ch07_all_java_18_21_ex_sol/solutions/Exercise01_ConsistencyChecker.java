...
public class Exercise01_ConsistencyChecker {
    public static void main(String[] args) {
        ...
        System.out.println(checkFirstNameTravelTimeAndDestZipCodeOrig(journey));
    ...
    static boolean checkFirstNameTravelTimeAndDestZipCodeOrig(Object obj) {
                ...
                if (journey.travelInfo() != null) {
                    ...
                    if (journey.to() != null) {
                        ...
                        if (firstname != null && travelTime != null && zipCode != null) {
                            ...
                            return firstname.length() > 2 && travelTime.toHours() < 7 && zipCode >= 8000
                                    && zipCode < 8100;
                        }
                    }
                }
    ...
    static boolean checkFirstNameAndCountryCodeAgain(Object obj) {
        if (obj instanceof Journey(
                ...
                City from,
                //
                //City(Integer fromZipCode, String fromName),
                City(Integer zipCode, String name)
        )) {
            ...
            System.out.println("One component null");
        }
        return false;
    }
