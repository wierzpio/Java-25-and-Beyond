...
public class Exercise05_UnnamedPatternsAndVariables {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(checkFirstNameAndCountryCodeAgainImproved_UNNAMED(journey));
        System.out.println(checkFirstNameAndCountryCodeAgainImproved_UNNAMED_2(journey));
        System.out.println();
        ...
        System.out.println(checkFirstNameAndCountryCodeAgainImproved_UNNAMED(journey2));
        System.out.println(checkFirstNameAndCountryCodeAgainImproved_UNNAMED_2(journey2));
        System.out.println();
        ...
        System.out.println(checkFirstNameAndCountryCodeAgainImproved_UNNAMED(journey3));
        System.out.println(checkFirstNameAndCountryCodeAgainImproved_UNNAMED_2(journey3));
    }
    ...
    static boolean checkFirstNameAndCountryCodeAgainImproved_UNNAMED(Object obj) {
        if (obj instanceof Journey(
                Person(var firstname, var _, var _),
                TravelInfo(var _, var maxTravellingTime), var _,
                City(var zipCode, var _)
        )) {
